...
public class JAbout extends javax.swing.JDialog {
    ...
    public void initFormParameters(FormsParameters.ParJAbout poParam) {
        try {
            this.setBounds(poParam.getoPos().getnPosX(), 
                ...
                850, 450); //Old: poParam.getoPos().getnSizeX(), poParam.getoPos().getnSizeY());
        }catch (Exception e) {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lblLogo, javax.swing.GroupLayout.DEFAULT_SIZE, 826, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(lblDevelopment, javax.swing.GroupLayout.DEFAULT_SIZE, 826, Short.MAX_VALUE)
    ...
    private void lblLogoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblLogoMouseClicked
        //Checks if several clics in certain area
        if (evt.getButton() == MouseEvent.BUTTON1 && evt.getClickCount()>=5 &&
                evt.getX()>=190 && evt.getX()<=240 &&
                evt.getY()>=35 && evt.getY()<=80) {
            JClientMain.setbForce(!JClientMain.isbForce());
            String vcMessage = resMessages.getString("info_force_stagedate_on");
            if (!JClientMain.isbForce())
                vcMessage = resMessages.getString("info_force_stagedate_off");
